...
async function renderizarDados(conteudo) {
    ...
    let codigoEstrutura = '<div class="cartao-padrao mb-lg pagina-dados">';
    ...
    codigoEstrutura += `
        <section class="cartao-suave painel-dados">
            ...
            <div class="rodape-painel-dados">
                ${criarBotao('Exportar Dados Selecionados', 'exportarBackupSelecionado()', 'primario', 'w-total')}
            </div>
        </section>
    `;
    ...
    codigoEstrutura += `
        <section class="cartao-suave painel-dados">
            ...
            ${criarBotao('Escolher Arquivo de Backup', 'escolherArquivoBackupRestauracao()', 'contorno', 'w-total')}
            ...
            <div id="controles-restauracao-dados" class="oculto">
                <div class="cabecalho-lista-dados">
            ...
            <div class="rodape-painel-dados">
                ${criarBotao('Restaurar Dados Selecionados', 'restaurarBackupSelecionado()', 'primario', 'w-total', 'button', 'id="botao-restaurar-dados" disabled')}
            </div>
        </section>
    `;
